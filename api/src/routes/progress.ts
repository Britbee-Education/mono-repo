...
progressRouter.post("/", (req: AuthedRequest, res) => {
  ...
  const snapshot: AppSnapshot = {
    ...
    yards: Array.isArray(body.yards) ? body.yards.slice(0, 12) : undefined,
    harvestDay: typeof body.harvestDay === "string" ? body.harvestDay.slice(0, 10) : undefined,
